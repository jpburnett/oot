...
s32 _link_home_scene_cutsceneData_00001040[] = 
{
	...
	CS_MISC_LIST(1),
		CS_MISC(0x000E, 645, 646, 0x0000, 0x0000, 0x0000, 0, 1, 0, 0, 1, 0, 0, 0, -1858218320),
	CS_MISC_LIST(1),
		CS_MISC(0x000C, 647, 648, 0x0000, 0x0000, 0x0001, 0, 2, 1, 0, 2, 0, 0, 0, -1858218320),
...
s32 _link_home_scene_cutsceneData_000015D0[] = 
{
	...
	CS_SCENE_TRANS_FX(12, 55, 81, -1858944640),
	CS_SCENE_TRANS_FX(13, 230, 301, -1858910464),
	CS_MISC_LIST(1),
		CS_MISC(0x000E, 40, 41, 0x0000, 0x0000, 0xFFFFFFFE, 0, -6, -2, 0, -6, 0, 0, 0, 1944352880),
	CS_MISC_LIST(1),
		CS_MISC(0x000E, 130, 131, 0x0000, 0x0000, 0xFFFFFFFE, 0, 4, -2, 0, 4, 0, 0, 0, 1944352880),
	CS_TEXT_LIST(6),
		CS_TEXT_NONE(0, 40),
